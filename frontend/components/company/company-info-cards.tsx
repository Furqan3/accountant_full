...
const CompanyInfoCards: React.FC<CompanyInfoCardsProps> = ({ company }) => {
  ...
  return (
    <div className="bg-white border-2 border-teal-200 rounded-2xl p-8 mb-6 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-5 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xl font-bold text-gray-900">{getCompanyType(company.type)}</p>
            </div>
          </div>
